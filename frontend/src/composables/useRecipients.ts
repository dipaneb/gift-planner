...
export function useRecipients() {
  ...
  async function fetchPaginated(params?: FetchParams): Promise<boolean> {
    ...
    try {
      ...
      error.value = getErrorMessage(err, t("errors.fetchRecipients"));
      return false;
    } finally {
      loading.value = false;
    }
  ...
  async function fetchAll(): Promise<boolean> {
    ...
    try {
      ...
      error.value = getErrorMessage(err, t("errors.fetchAllRecipients"));
      return false;
    } finally {
      loading.value = false;
    }
  ...
  async function fetchById(recipientId: string): Promise<boolean> {
    ...
    try {
      ...
      error.value = getErrorMessage(err, t("errors.fetchRecipient"));
      return false;
    } finally {
      loading.value = false;
    }
  ...
  async function createRecipient(data: RecipientCreate): Promise<boolean> {
    ...
    try {
      ...
      error.value = getErrorMessage(err, t("errors.createRecipient"));
      return false;
    } finally {
      loading.value = false;
    }
  ...
  async function updateRecipient(recipientId: string, data: RecipientUpdate): Promise<boolean> {
    ...
    try {
      ...
      error.value = getErrorMessage(err, t("errors.updateRecipient"));
      return false;
    } finally {
      loading.value = false;
    }
  ...
  async function deleteRecipient(recipientId: string): Promise<boolean> {
    ...
    try {
      ...
      error.value = getErrorMessage(err, t("errors.deleteRecipient"));
      return false;
    } finally {
      loading.value = false;
    }
