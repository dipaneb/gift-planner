<template>
  <div class="flex flex-col gap-6">
    ...
    <div
      class="flex flex-col sm:flex-row flex-wrap items-start sm:items-center justify-between gap-4 mb-5"
    >
    ...
    <!-- Filtered empty -->
    <div
      v-else-if="filteredGifts.length === 0 && statusFilter"
      class="text-center py-12 px-4 text-gray-500"
    >
      <p class="m-0 mb-5">
        {{ t("gifts.noGiftsWithStatus", { status: t(`gifts.status_labels.${statusFilter}`) }) }}
      </p>
